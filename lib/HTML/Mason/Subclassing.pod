...
To handle this, simply call the C<new_superclass()> method in your
constructor, like this:
  ...
  sub new
  {
      ...
      $class->new_superclass( $HTML::Mason::ApacheHandler::VERSION ?
...
subclasses provide important functionality.  The C<new_superclass()>
