...
To handle this, simply call the C<new_super()> method in your
constructor, like this:
  ...
  sub new
  {
      ...
      $class->new_super( $HTML::Mason::ApacheHandler::VERSION ?
...
subclasses provide important functionality.  The C<new_super()> method
is implemented in the L<C<HTML::Mason::Request>|HTML::Mason::Request>
base class, and will do the right thing even in cases of multiple
inheritance.  It also cooperates with C<Class::Container> to make sure
that it sees changes to the inheritance hierarchy.
...
you give it the appropriate C<interp_class> parameter.  This is
