...
Multiple escapes can be specified as a list:
...
This is done via the L<Interp object's add_escape()
method|HTML::Mason::Interp/item_add_escape>.  Escape names may be any
...
ADIMN<handler.pl|"CONFIGURING VIA HANDLER SCRIPT"> script like this:
