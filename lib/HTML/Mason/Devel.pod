...
If you are running Mason under mod_perl, you may find that sometimes
...
override the 'h' flag in a top-level autohandler or L<custom wrapper
code|HTML::Mason::Admin/"ADVANCED CONFIGURATION"> like this:

  $ah->interp->set_escape( h => \&escape_ISO_8859_2 );

where C<$ah> is an ApacheHandler object.
