...
(e.g. Cache::FileCache). Our documentation here covers common usage
but skips many options and features.

To use this feature the administrator will need to obtain Cache::Cache
from CPAN and may need to change C<Config.pm>.  See L<Admin/Data
...
C<$m-E<gt>cache->get> attempts to retrieve this component's cache
...
Cache::Cache is a purely virtual API implemented by a variety of
...
Cache::Cache subclass; if it does not contain a "::", the prefix
...
HTML::Mason::Utils::data_cache_namespace, given a component path, will
...
Cache::Cache will make a best effort to cache data until it expires,
