...
Request object's constructor, such as P<autoflush> or P<out_method>.
...
sets P<default_escape_flags> to 'h', then all <% %> expressions will
automatically be HTML-escaped.  In this case you would use the C<n>
...
L<HTML::Mason::Utils::data_cache_namespace|HTML::Mason::Utils/data_cache_namespace>,
