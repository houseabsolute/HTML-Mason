...
character set, and will interact badly with other encodings. See L<the
next section|HTML::Mason::Interp/"User-defined Escapes"> for how to
override this escaping. After 5.8.0, the encoding assumes that text is
in Unicode.
