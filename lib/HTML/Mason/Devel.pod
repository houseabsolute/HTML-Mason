...
Use code like this to initialize such variables in the E<lt>%initE<gt>
section:

    <%once>
    my $dbh;      # declare but don't assign
    ...
    my $init = 0; # have we initialized variables?
    </%once>
...
calls to C<$m-E<gt>cache>; Mason does not remember which subclass you
