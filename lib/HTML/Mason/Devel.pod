...
your administrator doesn't know then it is probably
'batch', the default.
...
no longer needed. For backwards compatibility, mc_suppress_http_header
is still defined but does nothing.
