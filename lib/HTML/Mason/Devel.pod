...
o L<Initialization and Cleanup> (mainly <%init>)
...
most once per request. <%init> offers more a predictable execution
time.
...
regular component contains, with the exception of <%def>, <%method>,
