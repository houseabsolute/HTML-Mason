...
guide|HTML::Mason::Admin>. There you will find information about site
...
guide|HTML::Mason::Admin> is for you too.
...
L<cache object|HTML::Mason::Devel/Cache Object> as its only
parameter. If the subroutine returns a true value, the item is
expired. In the example above, we expire the item whenever a certain
file changes.
