...
Apache::Request is the default and requires that you have install this
package.

If you specify 'CGI' then you must manually load the CGI module
yourself, either via a C<PerlModule> directive in your apache
configuration file or via a C<use> declaration in your handler.pl or
