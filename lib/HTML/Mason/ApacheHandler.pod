...
If you specific args_method='CGI', then the HTML::Mason::Request
object will have a method called C<cgi_object> available.  This method
will return the CGI object used in the ApacheHandler code.
