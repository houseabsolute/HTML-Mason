...
You will have to explicitly import the $m->* commands from C<HTML::Mason::Commands>
into your package. Ideally you will put this in your C<handler.pl>:

    { package MyPackage;
    use HTML::Mason::Commands; }

This will bring in all of the $m-> commands. If you want to save some
space on imported symbols, specify just the commands you want:

    { package MyPackage;
    use HTML::Mason::Commands qw($m->comp $m->file $m->cache); }
