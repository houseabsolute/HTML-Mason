...
one of [A-Za-z0-9/_.], the component path is assumed to be a literal
...
component call! The URL above is effectively translated to:

    mc_comp('/mktg/prods.html', str=>'dog', lst=>[2,3,4])

assuming that component root = document root.
