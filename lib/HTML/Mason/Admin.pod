...
PerlRequire directive to declare your handler.pl location (this can be
anywhere, though the Apache conf/ subdirectory is a good place as
any).  Second, set your PerlHandler simply to HTML::Mason rather than
