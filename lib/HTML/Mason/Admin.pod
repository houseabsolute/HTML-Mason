...
=item * MasonDebugHandlerProc - string

Correponds to the C<debug_handler_proc> parameter.

=item * MasonDebugHandlerScript - string

Correponds to the C<debug_handler_script> parameter.

=item * MasonDebugMode - string

Correponds to the C<debug_mode> parameter.

=item * MasonDebugPerlBinary - string

Correponds to the C<debug_perl_binary> parameter.
