...
L<Request/comp>, L<Request/stack>, and L<Request/fetch_comp> Request methods.
...
Similarly, there is no C<execute> method, because executing a
component requires an interpreter. All of the interfaces for calling a
component (<& &>, C<mc_comp>, C<$interp-E<gt>exec>, C<$REQ-E<gt>call>) which
normally take a component path, will also take a component object.
...
Returns the compiled form of the component as a code reference. You
should never invoke this directly but rather use one of the
established interfaces for calling components.
...
Returns the prefix used to resolve relative component paths from this
component. For file-based components this is the full component path
minus the final piece.  For subcomponents this is the same as its
parent component.  Undefined for anonymous components.
...
Returns a hash containing the subcomponents defined in this component,
with names as keys and component objects as values.
...
the previewer component trace, and C<mc_comp_stack>.
