...
beyond, C<mc_> commands have been replaced by the new B<L<HTML::Mason::Request>> API. e.g.
...
C<mc_suppress_http_header> (with or without argument) is no longer needed
and can simply be removed. See L<Devel/Sending HTTP Headers> for
more information.
