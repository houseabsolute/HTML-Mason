...
The methods C<comp>, C<comp_exists>, C<fetch_comp>, and
C<process_comp_path> take a component path as argument.
...
original arguments. Works like C<$m-E<gt>comp> in terms of return value and
