...
SIMPLE_OBJECTS:
{
    ...
    memory_cycle_ok( $interp,
        'Interp after making a request with in-memory comp' );
}
...
EOF
    ...
    memory_cycle_ok( $interp,
        'Interp after making a request with on-disk comp' );
...
EOF
    ...
    like( $output, qr/Destroyed: 1/, 'one object was destroyed in comp1' );
}
