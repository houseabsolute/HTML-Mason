...
use CGI qw(-no_debug)
  ;    # Prevent "(offline mode: enter name=value pairs on standard input)"

{
    ...
    sub _execute {
        ...
        $ENV{REQUEST_METHOD} =
          'GET';                   # CGI.pm needs this, or it won't process args
...
$group->add_test(
    ...
    expect =>
      qr/Status: 302\s+Location: \/hello\.html|Location: \/hello\.html\s+Status: 302/i,
);
